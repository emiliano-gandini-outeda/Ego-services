...
const en = {
  ...
  contact: {
    ...
    message: "Message",
    submit: "Send Message",
    success: "Message sent successfully to emiliano.outeda@gmail.com!",
    error: "There was an error sending your message. Please try again.",
    missingFields: "Please fill in all required fields.",
    formError: "There was a problem with your form submission. Please try again.",
    inappropriate_content: "Your message contains inappropriate content. Please revise and try again.",
    sending: "Sending...",
...
const es = {
  ...
  contact: {
    ...
    success: "¡Mensaje enviado con éxito a emiliano.outeda@gmail.com!",
    ...
    inappropriate_content: "Su mensaje contiene contenido inapropiado. Por favor, revíselo e inténtelo de nuevo.",
    sending: "Enviando...",
